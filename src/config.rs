...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("One AM Remote Support".to_owned());
...
pub const LINK_DOCS_HOME: &str = "https://oneam.it/";
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["gestionale.oneam.it"];
pub const RS_PUB_KEY: &str = "8X9RXqw8A26FDkLnDFshN+YJvUwzPX70MefsFu42+IU=";
